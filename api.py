...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        ...
        уникальным ключом пользователя, найденного по указанным email и паролем """
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        ...
        со списком найденных питомцев, совпадающих с фильтром. Но данный фильтр может иметь либо пустое значение -
    ...
    def add_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str, age: str) -> json:
        """ Метод отправляет (постит) на сервер данные о добавляемом питомце, но не передает фото, и возвращает
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """ Метод отправляет запрос на сервер о добавлении фото питомцу по указанному ID и возвращает
        статус запроса и result в формате JSON с обновлёнными данными питомца """
